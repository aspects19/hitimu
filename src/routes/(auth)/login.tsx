...
function Login() {
  ...
  return (
    <div className='flex flex-col w-full items-center pt-6'>
      ...
      <form className='flex flex-col mt-16 items-center' onSubmit={HandleLogin}>
        ...
        <div className='w-full flex flex-col justify-around px-4 gap-4 mt-8'>
          <button className=" w-full btn btn-outline btn-accent" type="button" onClick= {HandleLogin}>
            Login
          </button>
